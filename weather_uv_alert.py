...
API_KEY = "YWYZGEXXD499G8VUR9NP4WSTC"
...
@retry
def get_weather_by_hours_for_day_by_api(*, date: str, city: str) -> list[dict]:
...
date = "2023-08-04"
city = "London,UK"
weather_by_hour = get_weather_by_hours_for_day_by_api(date=date, city=city)
